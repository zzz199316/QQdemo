...
public class QQinfo extends View {
    ...
    public QQinfo(Context context) {
        this(context, null);
    }

    public QQinfo(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QQinfo(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
